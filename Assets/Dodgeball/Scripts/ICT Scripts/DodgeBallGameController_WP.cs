...
//Game controller for waypoint-based agents 
public class DodgeBallGameController_WP : MonoBehaviour
{
    ...
    {
        public DodgeBallAgent_autoshoot_plus_WP Agent;
    ...
    protected virtual void ResetScene()
    {
        ...
        {
            WaypointView wp = waypoints.transform.GetChild(i).gameObject.GetComponent<WaypointView>();
            wp.taken = false;
        }
